...
**注意**：本文件只放**项目内必须看到的拦截线摘要**，完整定义以对应 skill 为真相源。整体 SSOT 体系见 [skills/SSOT.md](../SSOT.md)。
...
- **不重述 skill 完整内容**——项目级规则只放拦截线摘要，完整定义是各 skill SKILL.md 的真相源。整体 SSOT 体系见 [skills/SSOT.md](../SSOT.md)

...
acr 体系的入口。其他 acr-* skill 管的是**已经有项目**后的流程（发散 / 写 prd / 写 spec / 计划 / 开发批次），本 skill 管的是**还没有规范**的时候——把流程骨架注入项目，让后续开发开箱即走 acr。
...
- **不重述 skill 完整内容**——项目级规则只放拦截线摘要，完整定义是各 skill SKILL.md 的真相源。全局真相源体系见 `docs/SSOT.md`
